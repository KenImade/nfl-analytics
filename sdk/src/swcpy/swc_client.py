...
class SWCClient:
    ...
    def __init__(self, input_config: config.SWCConfig):
        ...
        self.api_version = input_config.swc_api_version
        ...
        self.LIST_LEAGUES_ENDPOINT = f"/{self.api_version}/leagues/"
        self.LIST_PLAYERS_ENDPOINT = f"/{self.api_version}/players/"
        self.LIST_PERFORMANCES_ENDPOINT = f"/{self.api_version}/performances/"
        self.LIST_TEAMS_ENDPOINT = f"/{self.api_version}/teams/"
        self.GET_COUNTS_ENDPOINT = f"/{self.api_version}/counts/"
        ...
        logger.debug(f"Bulk file dictionary: {self.BULK_FILE_NAMES.items()}")
    ...
    def get_health_check(self) -> httpx.Response:
        ...
        status of API before making more complcated API calls.
    ...
    def list_leagues(
        ...
        Calls the API <version>/leagues endpoint and returns a list
        of League objects.
    ...
    def get_league_by_id(self, league_id: int) -> League:
        ...
        Calls the API <api-version>/leagues/{league_id} endpiont and
        returns single League.

        Returns:
        A schemas.League object representing one SportsWorldCentral fantasy league.
    ...
    def get_counts(self) -> Counts:
        ...
        Calls the API <api-version>/counts endpoint and returns a Counts object.
    ...
    def list_teams(
        ...
        Calls the API <api-version>/teams endpoint and returns a
        list of Team objects.

        Returns:
        A List of schemas.Team objects. Each represents one team
        in a SportsWorldCentral fantasy leauge.
    ...
    def list_players(
        ...
        Calls the API <api-version>/players endpoint and returns a list
        of Player objects.

        Returns:
        A List of schemas.Player objects. Each represents one NFL player.
        """
    ...
    def get_player_by_id(self, player_id: int) -> Player:
        """Returns a Player matching the SWC Player ID.

        Calls the API <api-version>/players/{player_id} endpoint
        and returns one Player object.
        """
    ...
    def list_performances(
        ...
        """Returns a List of Performance filtered by parameters.

        Calls the API <api-version>/performances endpoint and returns a list of
        Performance objects.

        Returns:
        A List of schemas.Performance objects. Each represents one player's
        scoring for one NFL week.
        """
