...
class SWCConfig:
    ...
    def __init__(
        ...
        swc_api_version (optional):
            The version of the API you want to interact with. Default value is set to latest version.
        swc_backoff:
            A boolean that determines if the SDK should retry the call
        ...
        self.swc_api_version = swc_api_version
    ...
    def __str__(self):
        ...
        return f"{self.swc_base_url} {self.swc_api_version} {self.swc_backoff} {self.swc_backoff_max_time} {self.swc_bulk_file_format}"
