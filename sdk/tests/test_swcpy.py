...
from swcpy.schemas import League, Team, Performance, Player, Counts
...
def test_list_leagues():
    ...
    # Assert the endpoing returned a list object
    assert isinstance(league_response, list)
...
def test_get_counts():
    ...
    count_response = client.get_counts()
    assert isinstance(count_response, Counts)


def test_list_teams():
    """Test list teams from SDK"""
    teams_response = client.list_teams()

    # Assert the list is not empty
    assert isinstance(teams_response, list)

    # Asset each item in the list is an instance of League
...
def test_list_players():
    ...
    # Assert each item in ths list is an instance of Player
