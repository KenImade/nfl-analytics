...
class HealthCheckTool(BaseTool):
    ...
    description: str = (
        "useful to check if the API is running before making other calls."
    )
...
class ListLeaguesTool(BaseTool):
    ...
    def _run(
        ...
        list_league_response = local_swc_client.list_leagues(league_name=league_name)
        return list_league_response
